...
import automail.Simulation.StatTracker;
    	...
    	switch(current_state) {
    		...
    		case DELIVERING:
    			...
    			if(current_floor == destination_floor){ // If already here drop off either way
                    ...
                    Simulation.StatTracker.delivered_normal += 1;
                    Simulation.StatTracker.total_weight_normal += deliveryItem.getWeight();
                    deliveryItem = null;
                    deliveryCounter++;
    		...
    		case WRAP_STAGE_1:
    			...
    			Simulation.StatTracker.total_wrapping_time += 1;
    			break;
    		case WRAP_STAGE_2:
    		...
    		case DELIVER_FRAGILE:
    			...
    			Simulation.StatTracker.total_unwrapping_time += 1;
				delivery.deliver(specialHand);
				Simulation.StatTracker.delivered_caution += 1;
				Simulation.StatTracker.total_weight_caution += specialHand.getWeight();
				specialHand = null;
				deliveryCounter++;
